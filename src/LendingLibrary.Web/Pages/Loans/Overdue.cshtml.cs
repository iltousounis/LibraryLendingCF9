...
public class OverdueModel(ILendingService lendingService, UserManager<ApplicationUser> userManager) : PageModel
{
    ...
    public async Task OnGetAsync()
    {
        ...
        Results = await lendingService.GetUserLoansAsync(userId, LoanView.Overdue, PageNumber, PageSize);
    }
}

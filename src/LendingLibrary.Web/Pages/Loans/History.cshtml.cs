...
public class HistoryModel(ILendingService lendingService, UserManager<ApplicationUser> userManager) : PageModel
{
    ...
    public PagerViewModel Pager => new()
    {
        ...
        PageUrl = p => Url.Page("./History", new { page = p })!
    };

    public async Task OnGetAsync()
    {
        var userId = Guid.Parse(userManager.GetUserId(User)!);
        Results = await lendingService.GetUserLoansAsync(userId, LoanView.History, PageNumber, PageSize);
    }
}
